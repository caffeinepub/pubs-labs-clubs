...
const navCards: NavCard[] = [
  ...
  },
  {
    ...
    description:
      "Track publishing catalog, contributors, and ownership splits.",
  ...
  },
  {
    title: "Releases",
    description:
      "Coordinate label releases, tracklists, and workflow checklists.",
  ...
  },
  {
    ...
    description:
      "Oversee recording sessions, participants, and project status.",
  ...
  },
  {
    ...
    description:
      "Plan goals, milestones, and development strategies for artists.",
