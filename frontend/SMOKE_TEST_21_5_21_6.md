# Rollout 21.5–21.6 Post-Upgrade Smoke Test Checklist

This document provides a concise smoke test checklist for verifying the Higgins Music Hub application after the rollout 21.5–21.6 build/upgrade deployment.

## Purpose

Confirm that the frontend loads successfully, navigation works, and key portal detail routes render without runtime crashes after the canister upgrade. This rollout focuses on verifying that all five detail routes and "Edit Links" dialogs work correctly for both admin and non-admin approved member roles.
...
Document all test outcomes in `frontend/UPGRADE_LINKING_VERIFICATION_RESULTS.md` under the "Rollout 21.5–21.6 Smoke Test Results" section.
...
All checklist items above must pass for the rollout 21.5–21.6 deployment to be considered successful.
