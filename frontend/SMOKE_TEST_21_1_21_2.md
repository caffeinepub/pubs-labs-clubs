# Rollout 21.1–21.2 Post-Upgrade Smoke Test Checklist

This document provides a concise smoke test checklist for verifying the Higgins Music Hub application after the rollout 21.1–21.2 build/upgrade deployment.

## Purpose

Confirm that the frontend loads successfully, navigation works, and key portal detail routes render without runtime crashes after the canister upgrade.
...
- **Upgrade-safe behavior**: Array normalization prevents crashes when data shapes change

## Recording Results

Document all test outcomes in `frontend/UPGRADE_LINKING_VERIFICATION_RESULTS.md` under the "Rollout 21.1–21.2 Smoke Test Results" section.
...
All checklist items above must pass for the rollout 21.1–21.2 deployment to be considered successful.
