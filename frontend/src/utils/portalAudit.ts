...
export const PORTAL_AUDIT_FINDINGS: AuditFinding[] = [
  ...
  },
  {
    ...
    sectionName: 'Memberships',
    sectionPath: '/portal/memberships',
    featureDescription: 'Expanded member registration form (phone, genre, role, social links, etc.)',
    suggestedPriority: 'high',
    context:
  ...
  },
  {
    ...
    sectionName: 'Publishing Works',
    sectionPath: '/portal/publishing',
    featureDescription: 'Contributor role management (composer, lyricist, arranger)',
    suggestedPriority: 'medium',
    context:
  ...
  },
  {
    ...
    sectionName: 'Publishing Works',
    sectionPath: '/portal/publishing',
    featureDescription: 'Bulk operations and advanced search/filter on the list page',
  ...
  // ── RECORDING PROJECTS ───────────────────────────────────────────────────────
  {
    ...
    featureDescription: 'Asset reference management UI (file links, stems, mixes)',
    suggestedPriority: 'high',
    context:
  ...
  },
  {
    ...
    sectionName: 'Recording Projects',
    sectionPath: '/portal/recordings',
    featureDescription: 'Status transition workflow (planned → in progress → completed → archived)',
    suggestedPriority: 'high',
    context:
  ...
  },
  {
    ...
    sectionName: 'Recording Projects',
    sectionPath: '/portal/recordings',
    featureDescription: 'Participant role management (artist, producer, engineer, mixer)',
    suggestedPriority: 'medium',
    context:
  ...
  },
  {
    ...
    sectionName: 'Artist Development',
    sectionPath: '/portal/artists',
    featureDescription: 'Progress visualisation (milestone completion percentage)',
    suggestedPriority: 'medium',
    context:
...
export function findingsBySection(): Record<string, AuditFinding[]> {
  return PORTAL_AUDIT_FINDINGS.reduce<Record<string, AuditFinding[]>>((acc, finding) => {
