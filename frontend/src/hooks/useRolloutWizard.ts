...
const ROLLOUT_STEPS: RolloutStep[] = [
  ...
  },
  {
    ...
    description:
      'Incorporate user feedback to improve UX and performance. Fix remaining bugs and issues. Integrate CI/CD pipeline.',
    requiresConfirmation: false,
    actionItems: [
      'Collect and triage user feedback from initial mainnet usage',
      'Prioritise and fix any bugs or regressions identified post-launch',
      'Improve UX based on feedback (navigation, forms, error messages)',
      'Set up CI/CD pipeline for automated builds and deployments',
      'Document any known limitations or deferred improvements',
    ],
    acceptanceCriteria: [
      'Critical post-launch bugs are resolved',
      'CI/CD pipeline is operational',
      'User feedback is triaged and prioritised',
    ],
  },
  {
    id: 'step-12',
    ...
    description:
      'Plan and implement system maintenance procedures. Add improvements as needed. Train core team on system maintenance. Maintain documentation and change logs.',
    requiresConfirmation: false,
    actionItems: [
      'Define and document maintenance procedures for canister upgrades',
      'Train core team members on deployment and upgrade processes',
      'Establish a regular review cadence for security and dependency updates',
      'Maintain and update ROLLOUT_STEPS.md and related documentation',
      'Plan and implement feature improvements based on long-term roadmap',
    ],
    acceptanceCriteria: [
      'Maintenance procedures are documented',
      'Core team is trained on system maintenance',
