...
const priorityConfig: Record<
  AuditPriority,
  { label: string; icon: React.ElementType; containerClass: string; iconClass: string; badgeClass: string }
> = {
  high: {
    label: 'High Priority',
    icon: Zap,
  ...
  low: {
    label: 'Low Priority',
    icon: Info,
    containerClass: 'border-muted bg-muted/30 dark:border-muted dark:bg-muted/10',
