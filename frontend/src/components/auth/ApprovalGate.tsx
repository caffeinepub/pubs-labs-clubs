// TEMP: approval gate disabled for testing
// To re-enable: remove the early return below and restore the original approval check logic
...
export default function ApprovalGate({ children }: ApprovalGateProps) {
  // TEMP: approval gate disabled for testing — always render children
  return <>{children}</>;

  // --- ORIGINAL APPROVAL GATE LOGIC (kept intact for easy reversion) ---
